...
export default function DashboardLayout() {
  ...
  return (
    // Full screen background (center the dashboard on giant monitors)
    <div className="min-h-screen w-full bg-eumedical-light-grey flex justify-center">

      {/* App Shell */}
      <div className="w-full max-w-[1440px] h-screen flex flex-col overflow-hidden bg-eumedical-light-grey shadow-2xl relative">
        ...
        <header className="h-16 flex items-center justify-between px-4 md:px-8 shrink-0">
          ...
          <button
            ...
            className="md:hidden p-2 -mr-2 text-eumedical-dark-blue/70 hover:bg-eumedical-light-grey rounded-lg 
        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          <aside className="hidden md:flex flex-col w-64 shrink-0 pb-4">
            ...
            <div className="pl-4 md:pl-8 mt-auto">
              <Link
                to="/login"
                className="flex items-center gap-3 bg-eumedical-white/90 hover:bg-red-50 text-red-600 
                font-didact text-lg px-5 py-4 transition-colors rounded-2xl mr-4"
              >
          ...
          >
            ...
            <aside 
              className={
                `relative w-72 h-full flex flex-col bg-eumedical-light-grey shadow-xl transition-transform duration-300 ease-in-out ${
            ...
            >
              <div className="flex items-center justify-between p-4 border-b border-eumedical-light-blue shrink-0">
                ...
                <button
                  type="button"
                  onClick={() => setIsMobileMenuOpen(false)}
                  className="p-2 text-eumedical-dark-blue/70 hover:bg-eumedical-light-grey rounded-lg 
                  focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-eumedical-medium-aquamarine"
                    ...
                    <NavLink
                      ...
                      className={({ isActive }) =>
                        `flex items-center gap-3 px-4 py-3 rounded-xl font-didact text-lg transition-colors ${
                          isActive
                            ? 'bg-eumedical-medium-aquamarine text-eumedical-white font-bold'
